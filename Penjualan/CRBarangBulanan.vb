...
Public Class CRBarangBulanan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penjualan.CRBarangBulanan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRBarangBulanan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRBarangBulanan = New CRBarangBulanan()
        rpt.Site = Me.Site
        Return rpt
    End Function
