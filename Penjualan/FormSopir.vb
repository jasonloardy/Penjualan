...
Public Class FormSopir
    ...
    End Sub
    Sub isigrid()
        Dim query As String = "SELECT kd_sopir, nama_sopir, " _
                            & "CASE " _
                            & "WHEN status = 'A' then 'Aktif' " _
                            & "WHEN status = 'N' then 'Non-aktif' " _
                            & "END " _
                            & "FROM tb_sopir"
    ...
    Sub querytambah()
        ...
        QuerySopir(query, tbkdsopir.Text, tbnamasopir.Text.ToUpper, cbstatus.Text.Substring(0, 1))
    ...
    Sub queryedit()
        ...
        QuerySopir(query, id_data, tbnamasopir.Text.ToUpper, cbstatus.Text.Substring(0, 1))
