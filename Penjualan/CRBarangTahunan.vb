...
Public Class CRBarangTahunan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penjualan.CRBarangTahunan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_transaksi() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRBarangTahunan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRBarangTahunan = New CRBarangTahunan()
        rpt.Site = Me.Site
        Return rpt
    End Function
