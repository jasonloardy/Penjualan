...
Public Class CRPenjualanAntar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penjualan.CRPenjualanAntar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPenjualanAntar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPenjualanAntar = New CRPenjualanAntar()
        rpt.Site = Me.Site
        Return rpt
    End Function
