...
Public Class CRPenjualanTahunan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penjualan.CRPenjualanTahunan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPenjualanTahunan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPenjualanTahunan = New CRPenjualanTahunan()
        rpt.Site = Me.Site
        Return rpt
    End Function
