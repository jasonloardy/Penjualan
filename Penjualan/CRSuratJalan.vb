...
Public Class CRSuratJalan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penjualan.CRSuratJalan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_kd_suratjalan() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRSuratJalan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRSuratJalan = New CRSuratJalan()
        rpt.Site = Me.Site
        Return rpt
    End Function
