...
Public Class CRPenjualanHarian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penjualan.CRPenjualanHarian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPenjualanHarian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPenjualanHarian = New CRPenjualanHarian()
        rpt.Site = Me.Site
        Return rpt
    End Function
